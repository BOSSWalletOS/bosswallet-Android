package com.bosswallet.token.web;

import static com.bosswallet.token.tools.Convert.getEthString;
import static com.bosswallet.token.tools.ParseMagicLink.normal;
import static com.bosswallet.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
import com.bosswallet.token.entity.MagicLinkInfo;
...
import com.bosswallet.token.web.Ethereum.TokenscriptFunction;
import com.bosswallet.token.web.Ethereum.TransactionHandler;
import com.bosswallet.token.web.Service.CryptoFunctions;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.bosswallet\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://bosswallet.com");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using BossWallet with WalletConnect and facing issues please take the following steps:<br/><br/>\nTry using WalletConnect V2 (or latest version)<br/>\nTry launching the application from within BossWallet app's Browser tab.<br/>";
        }
