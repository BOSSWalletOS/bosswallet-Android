...
import com.bosswallet.token.util.DateTime;
import com.bosswallet.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'BossWallet meetup indices' where 'Match' mapping is null but for FIFA is not.
