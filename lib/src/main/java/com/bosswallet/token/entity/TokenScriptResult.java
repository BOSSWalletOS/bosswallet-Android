...
import static com.bosswallet.token.tools.TokenDefinition.Syntax.IA5String;
...
public class TokenScriptResult
{
    public static final class Attribute {
        ...
        public Attribute(com.bosswallet.token.entity.Attribute attr, BigInteger value, String text)
        {
            this.id = attr.name;
