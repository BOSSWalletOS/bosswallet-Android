...
-keep class com.bosswallet.token.** { *; }
-keep class com.bosswallet.app.walletconnect.** { *; }
-keep class com.bosswallet.app.web3.** { *; }
-keep class com.bosswallet.app.web3j.** { *; }
-keep class com.bosswallet.app.entity.** { *; }
