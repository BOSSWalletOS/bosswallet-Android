...
public abstract class C {
    ...
    public static final String ALPHAWALLET_WEB = "https://www.bosswallet.com";
    ...
    public static final String APP_FOREGROUND_STATE = "com.bosswallet.app_FOREGROUND_STATE";
    public static final String EXTRA_APP_FOREGROUND = "com.bosswallet.IS_FOREGORUND";
    public static final String QRCODE_SCAN = "com.bosswallet.QRSCAN";
    public static final String AWALLET_CODE = "com.bosswallet.AWALLET";
    public static final String SIGNAL_NFT_SYNC = "com.bosswallet.SYNC_NFT";
    public static final String SYNC_STATUS = "com.bosswallet.SYNC_STATUS";
    ...
    public static final String DAPP_PREFIX_ALPHAWALLET = "bosswallet";
    ...
    public static final String ALPHAWALLET_LOGO_URI = "https://bosswallet.com/wp-content/themes/bosswallet/img/logo-horizontal-new.svg";
    public static final String ALPHAWALLET_WEBSITE = "https://bosswallet.com";
    ...
    public static final String EXTERNAL_APP_DOWNLOAD_LINK = "https://bosswallet.com/download/BossWallet-release-build.apk";
