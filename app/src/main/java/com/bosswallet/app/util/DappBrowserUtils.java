...
public class DappBrowserUtils
{
    ...
    private static final String DEFAULT_HOMEPAGE = "https://bosswallet.com/browser/";
    private static final String POLYGON_HOMEPAGE = "https://bosswallet.com/browser-item-category/polygon/";
