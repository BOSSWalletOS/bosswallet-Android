...
import static com.bosswallet.app.entity.EventSync.BLOCK_SEARCH_INTERVAL;
import static com.bosswallet.app.entity.EventSync.OKX_BLOCK_SEARCH_INTERVAL;
import static com.bosswallet.app.entity.EventSync.POLYGON_BLOCK_SEARCH_INTERVAL;
import static com.bosswallet.app.util.Utils.isValidUrl;
import static com.bosswallet.ethereum.EthereumNetworkBase.ARBITRUM_GOERLI_TESTNET_FALLBACK_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.ARBITRUM_GOERLI_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.ARBITRUM_MAIN_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.AURORA_MAINNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.AURORA_MAINNET_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.AURORA_TESTNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.AURORA_TESTNET_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.AVALANCHE_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.AVALANCHE_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.BINANCE_MAIN_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.BINANCE_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.CLASSIC_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.CRONOS_MAIN_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.CRONOS_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.FANTOM_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.FANTOM_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.FANTOM_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.FANTOM_TEST_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.FUJI_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.FUJI_TEST_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.GNOSIS_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.GOERLI_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.HECO_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.HECO_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.HOLESKY_FALLBACK_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.HOLESKY_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.HOLESKY_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.IOTEX_MAINNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.IOTEX_MAINNET_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.IOTEX_TESTNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.IOTEX_TESTNET_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.KLAYTN_BAOBAB_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.KLAYTN_BAOBAB_RPC;
import static com.bosswallet.ethereum.EthereumNetworkBase.KLAYTN_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.KLAYTN_RPC;
import static com.bosswallet.ethereum.EthereumNetworkBase.LINEA_FREE_RPC;
import static com.bosswallet.ethereum.EthereumNetworkBase.LINEA_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.LINEA_TEST_FREE_RPC;
import static com.bosswallet.ethereum.EthereumNetworkBase.LINEA_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.MAINNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.MILKOMEDA_C1_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.MILKOMEDA_C1_RPC;
import static com.bosswallet.ethereum.EthereumNetworkBase.MILKOMEDA_C1_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.MILKOMEDA_C1_TEST_RPC;
import static com.bosswallet.ethereum.EthereumNetworkBase.OKX_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.OKX_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.OPTIMISM_GOERLI_TESTNET_FALLBACK_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.OPTIMISM_GOERLI_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.OPTIMISTIC_MAIN_FALLBACK_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.OPTIMISTIC_MAIN_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.PALM_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.PALM_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.POLYGON_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.POLYGON_TEST_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.ROOTSTOCK_MAINNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.ROOTSTOCK_MAINNET_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.ROOTSTOCK_TESTNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.ROOTSTOCK_TESTNET_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.SEPOLIA_TESTNET_ID;
import static com.bosswallet.ethereum.EthereumNetworkBase.SEPOLIA_TESTNET_RPC_URL;
import static com.bosswallet.ethereum.EthereumNetworkBase.XDAI_RPC_URL;

import android.text.TextUtils;
import android.util.LongSparseArray;

import com.bosswallet.app.R;
import com.bosswallet.token.entity.ChainSpec;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    /* constructing URLs from BuildConfig. In the below area you will see hardcoded key like da3717...
       These hardcoded keys are fallbacks used by BossWallet forks.
...
//    public static final boolean usesProductionKey = !keyProvider.getInfuraKey().equals(DEFAULT_INFURA_KEY);
    public static final boolean usesProductionKey = false;
    ...
    //Note that BossWallet now uses a double node configuration. See class AWHttpService comment 'try primary node'.
