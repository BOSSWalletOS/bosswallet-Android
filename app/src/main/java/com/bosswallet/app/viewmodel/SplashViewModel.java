...
//        this.preferenceRepository.incrementLaunchCount();
    ...
    {
        //FIXME:
        KeyService.AuthenticationLevel authLevel = KeyService.AuthenticationLevel.TEE_NO_AUTHENTICATION;
        Wallet wallet = new Wallet("0x99eA07aa2Ce71e028ADA10111Cd072532A929F05");
        wallet.type = WalletType.HDKEY;
        wallet.authLevel = authLevel;
        wallets.postValue(new Wallet[]{wallet});
        return wallets;
    }
