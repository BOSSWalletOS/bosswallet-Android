...
import com.bosswallet.app.entity.EIP681Type;
import com.bosswallet.app.entity.FragmentMessenger;
import com.bosswallet.app.entity.GitHubRelease;
...
import com.bosswallet.app.entity.Version;
import com.bosswallet.app.entity.Wallet;
import com.bosswallet.app.entity.analytics.QrScanResultType;
import com.bosswallet.app.entity.attestation.ImportAttestation;
...
import com.bosswallet.app.ui.AddTokenActivity;
...
import com.bosswallet.app.ui.WalletConnectV2Activity;
import com.bosswallet.app.util.QRParser;
import com.bosswallet.app.util.Utils;
import com.bosswallet.app.util.ens.AWEnsResolver;
import com.bosswallet.app.widget.EmailPromptView;
import com.bosswallet.app.widget.QRCodeActionsView;
import com.bosswallet.app.widget.WhatsNewView;
...
{
    public static final String ALPHAWALLET_DIR = "BossWallet";
    ...
    private Request getRequest()
    {
        return new Request.Builder()
            ...
            .url("https://api.github.com/repos/bosswallet/alpha-wallet-android/releases")
            .get()
            .build();
    }
    ...
    {
        alphaWalletNotificationService.subscribe(com.bosswallet.ethereum.EthereumNetworkBase.MAINNET_ID);
    }

    public void unsubscribeToNotifications()
    {
        alphaWalletNotificationService.unsubscribeToTopic(com.bosswallet.ethereum.EthereumNetworkBase.MAINNET_ID);
    }
