...
public class Web3View extends WebView {
    ...
    private static final String JS_PROTOCOL_ON_SUCCESSFUL = "BossWallet.executeCallback(%1$s, null, \"%2$s\")";
    private static final String JS_PROTOCOL_EXPR_ON_SUCCESSFUL = "BossWallet.executeCallback(%1$s, null, %2$s)";
    private static final String JS_PROTOCOL_ON_FAILURE = "BossWallet.executeCallback(%1$s, \"%2$s\", null)";
