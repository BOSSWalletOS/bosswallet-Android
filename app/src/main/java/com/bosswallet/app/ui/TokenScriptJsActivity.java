...
import com.bosswallet.app.entity.StandardFunctionInterface;
...
import com.bosswallet.app.util.ShortcutUtils;
import com.bosswallet.app.viewmodel.DappBrowserViewModel;
import com.bosswallet.app.viewmodel.TokenFunctionViewModel;
...
import com.bosswallet.app.widget.CertifiedToolbarView;
        ...
        OnEthCallListener, OnWalletAddEthereumChainObjectListener, OnWalletActionListener
{
    ...
    private void openTokenscriptWebview(Wallet wallet)
    {
        try
        {
            ...
            tokenScriptView.loadUrl(VIEWER_URL + "/?viewType=bosswallet&chain=" + chainId + "&contract=" + token.tokenInfo.address + "&tokenId=" + tokenId);
        }
        catch (Exception e)
        {
            Timber.e(e);
    ...
    private void showErrorDialogIncompatibleNetwork(long callbackId, long requestingChainId, long activeChainId)
    {
        if (getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED))
        {
            ...
            String message = com.bosswallet.app.repository.EthereumNetworkBase.isChainSupported(requestingChainId) ?
                    getString(R.string.error_eip712_incompatible_network,
                            com.bosswallet.app.repository.EthereumNetworkBase.getShortChainName(requestingChainId),
                            com.bosswallet.app.repository.EthereumNetworkBase.getShortChainName(activeChainId)) :
