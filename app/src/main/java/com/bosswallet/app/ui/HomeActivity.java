...
import static com.bosswallet.app.C.RESET_WALLET;
import static com.bosswallet.app.C.SHOW_BACKUP;
import static com.bosswallet.app.entity.WalletPage.ACTIVITY;
import static com.bosswallet.app.entity.WalletPage.DAPP_BROWSER;
import static com.bosswallet.app.entity.WalletPage.WALLET;
...
import com.bosswallet.app.util.UpdateUtils;
...
import com.bosswallet.app.entity.DeepLinkRequest;
import com.bosswallet.app.entity.ErrorEnvelope;
import com.bosswallet.app.entity.FragmentMessenger;
import com.bosswallet.app.entity.HomeCommsInterface;
import com.bosswallet.app.entity.HomeReceiver;
import com.bosswallet.app.entity.MediaLinks;
import com.bosswallet.app.entity.SignAuthenticationCallback;
import com.bosswallet.app.entity.Wallet;
import com.bosswallet.app.entity.WalletPage;
import com.bosswallet.app.entity.WalletType;
import com.bosswallet.app.entity.attestation.AttestationImportInterface;
import com.bosswallet.app.entity.attestation.SmartPassReturn;
import com.bosswallet.app.entity.tokens.TokenCardMeta;
import com.bosswallet.app.router.ImportTokenRouter;
import com.bosswallet.app.service.DeepLinkService;
import com.bosswallet.app.service.GasService;
import com.bosswallet.app.service.PriceAlertsService;
import com.bosswallet.app.ui.widget.entity.ActionSheetCallback;
import com.bosswallet.app.ui.widget.entity.PagerCallback;
import com.bosswallet.app.util.LocaleUtils;
import com.bosswallet.app.util.Utils;
import com.bosswallet.app.viewmodel.BaseNavigationActivity;
import com.bosswallet.app.viewmodel.HomeViewModel;
import com.bosswallet.app.viewmodel.WalletConnectViewModel;
...
import com.bosswallet.app.widget.AWalletConfirmationDialog;
import com.bosswallet.app.widget.SignTransactionDialog;
    ...
    public void onStateChanged(@NonNull LifecycleOwner source, @NonNull Lifecycle.Event event)
    {
        switch (event)
        {
            case ON_CREATE:
                break;
            case ON_START:
                Timber.tag("LIFE").d("BossWallet into foreground");
                handler.postDelayed(() -> {
                    if (viewModel != null)
                    {
            ...
            case ON_PAUSE:
                break;
            case ON_STOP:
                Timber.tag("LIFE").d("BossWallet into background");
    ...
    private void checkWarnings()
    {
        if (updatePrompt)
        {
            ...
            if (warns < 3)
            {
                ...
                cDialog.setSmallText("Using an old version of Bosswallet. Please update from the Play Store or Bosswallet website.");
