...
import com.bosswallet.app.entity.analytics.TokenSwapEvent;
import com.bosswallet.app.entity.lifi.Chain;
import com.bosswallet.app.entity.lifi.Connection;
import com.bosswallet.app.entity.lifi.Quote;
import com.bosswallet.app.entity.lifi.Token;
import com.bosswallet.app.service.GasService;
import com.bosswallet.app.ui.widget.entity.ActionSheetCallback;
import com.bosswallet.app.ui.widget.entity.ProgressInfo;
import com.bosswallet.app.util.BalanceUtils;
import com.bosswallet.app.util.SwapUtils;
import com.bosswallet.app.viewmodel.SwapViewModel;
import com.bosswallet.app.viewmodel.Tokens;
...
import com.bosswallet.app.widget.SelectTokenDialog;
import com.bosswallet.app.widget.StandardHeader;
import com.bosswallet.app.widget.SwapSettingsDialog;
import com.bosswallet.app.widget.TokenInfoView;
import com.bosswallet.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.bosswallet.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.bosswallet.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
